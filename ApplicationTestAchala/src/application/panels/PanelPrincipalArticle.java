...
public class PanelPrincipalArticle extends JPanel {
	...
	public PanelPrincipalArticle(String nomUser, String prenomUser) {
		...
		/**
		 * Panel qui affiche les differents menu ( Article , Edition d'un nouvel
		 * article , Chat )
		 *
		 */
		this.nom = nomUser;
		...
		Publier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Article nouvelArticle = new Article(panelEdition.getTextFieldTitre().getText(),
						panelEdition.getTextAreaArticle().getText(), nomUser + " " + prenomUser, txtDate);

				PanelAppercuArticle paa = new PanelAppercuArticle(nouvelArticle, nomUser, prenomUser);
				//Boutton qui supprime l'article en base
